		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=119345&schain=1.0,1!pubgalaxy.com,13467,1&cbuster=%%CACHEBUSTER%%&cbuster=1758024202',
					origQString: 's=119345&schain=1.0,1!pubgalaxy.com,13467,1&cbuster=%%CACHEBUSTER%%',
					placementId: 119345,
					x: 310,
					y: 260,
					videoType: 'slider',
